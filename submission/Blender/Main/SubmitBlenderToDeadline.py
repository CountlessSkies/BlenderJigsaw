...
def main( ):
    ...
    output_path = str(curr_render.filepath)
    ...
    resolution_x = curr_render.resolution_x
    resolution_y = curr_render.resolution_y
    resolution_percentage = curr_render.resolution_percentage

    # Calculate effective resolution
    effective_resolution_x = int(resolution_x * (resolution_percentage / 100))
    effective_resolution_y = int(resolution_y * (resolution_percentage / 100))
    
    extension = curr_render.image_settings.file_format
    ...
    args.append(str(effective_resolution_x))
    args.append(str(effective_resolution_y))
    args.append(str(extension))
